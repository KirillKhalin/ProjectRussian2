...
public class ActivitySR2 extends AppCompatActivity implements View.OnDragListener, View.OnLongClickListener {
    ...
    public void goAnswer(View view) {
        ...
        tView.setText(" сделал сначала (нар.) ");
        tView = (TextView) findViewById(R.id.txt2);
        tView.setText(" шел с начала спектакля (предлог + сущ.) ");
        tView = (TextView) findViewById(R.id.txt3);
        tView.setText(" он тоже бежал (=и) ");
        tView = (TextView) findViewById(R.id.txt4);
        tView.setText(" делал то же задание (мест. + же) ");
        tView = (TextView) findViewById(R.id.txt5);
        tView.setText(" наполовину (нар.) ");
        tView = (TextView) findViewById(R.id.txt6);
        tView.setText(" полумрак (полу всегда слитно) ");
        tView = (TextView) findViewById(R.id.txt7);
        tView.setText(" вследствие сильной засухи (произ. предлог) ");
        tView = (TextView) findViewById(R.id.txt8);
        tView.setText(" в следствие по делу внесли (предлог + сущ.) ");
        tView = (TextView) findViewById(R.id.txt9);
        tView.setText(" в течение недели (произ. предлог) ");
        tView = (TextView) findViewById(R.id.txt10);
        tView.setText(" в течение реки бросили (предлог + сущ.) ");
        tView = (TextView) findViewById(R.id.txt11);
        tView.setText(" впоследствии (всегда слитно + ии) ");
        tView = (TextView) findViewById(R.id.txt12);
        tView.setText(" ..., оттого ... (причина -> слитно) ");
    }

    public void goNext(View view) {
        Intent intent = new Intent(this, ActivitySuf2.class);
        startActivity(intent);
    }
}