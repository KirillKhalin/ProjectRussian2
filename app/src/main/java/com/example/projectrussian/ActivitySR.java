...
public class ActivitySR extends AppCompatActivity implements View.OnDragListener, View.OnLongClickListener {
    ...
    public void goAnswer(View view) {
        ...
        tView.setText(" повело вбок (нар.) ");
        tView = (TextView) findViewById(R.id.txt2);
        tView.setText(" ..., поэтому ... (нар.) ");
        tView = (TextView) findViewById(R.id.txt3);
        tView.setText(" зачастую (нар.) ");
        tView = (TextView) findViewById(R.id.txt4);
        tView.setText(" ..., насколько ... (нар.) ");
        tView = (TextView) findViewById(R.id.txt5);
        tView.setText(" все же (частица же всегда разд.) ");
        tView = (TextView) findViewById(R.id.txt6);
        tView.setText(" пригласить в место (предлог + сущ.) ");
        tView = (TextView) findViewById(R.id.txt7);
        tView.setText(" настолько привык (нар.) ");
        tView = (TextView) findViewById(R.id.txt8);
        tView.setText(" врал на ходу (запомнить) ");
        tView = (TextView) findViewById(R.id.txt9);
        tView.setText(" во время путешествий (предлог + сущ.) ");
        tView = (TextView) findViewById(R.id.txt10);
        tView.setText(" по ходу поезду (предлог + сущ.) ");
        tView = (TextView) findViewById(R.id.txt11);
        tView.setText(" как будто (всегда раздельно) ");
        tView = (TextView) findViewById(R.id.txt12);
        tView.setText(" полдома (согл. не л) ");
    }

    public void goNext(View view) {
        Intent intent = new Intent(this, ActivitySR2.class);
        startActivity(intent);
    }
}