...
public class ActivityNNN extends AppCompatActivity implements View.OnDragListener, View.OnLongClickListener {
    ...
    public void goAnswer(View view) {
        ...
        tView.setText(" покрашеНа (кр. прич.) ");
        tView = (TextView) findViewById(R.id.txt2);
        tView.setText(" (девушка) образоваННа (прил. от образованная) ");
        tView = (TextView) findViewById(R.id.txt3);
        tView.setText(" срезаННый (прич. сов.в.) ");
        tView = (TextView) findViewById(R.id.txt4);
        tView.setText(" решеННая (задача) (прич. сов.в.) ");
        tView = (TextView) findViewById(R.id.txt5);
        tView.setText(" провалеННый (прич. приставка кроме не) ");
        tView = (TextView) findViewById(R.id.txt6);
        tView.setText(" ранеННый врагом (прич. есть зав.сл.) ");
        tView = (TextView) findViewById(R.id.txt7);
        tView.setText(" ранеНый человек (отгл. прил. 4 нет) ");
        tView = (TextView) findViewById(R.id.txt8);
        tView.setText(" ранеНый упал (субст. прил. 4 нет) ");
        tView = (TextView) findViewById(R.id.txt9);
        tView.setText(" зачароваННая (прич. ова/ева) ");
        tView = (TextView) findViewById(R.id.txt10);
        tView.setText(" заколдоваНа (кр. прич) ");
        tView = (TextView) findViewById(R.id.txt11);
        tView.setText(" жеваНый (отгл. прил. искл.) ");
        tView = (TextView) findViewById(R.id.txt12);
        tView.setText(" желаННый (отгл. прил. искл.) ");
    }
