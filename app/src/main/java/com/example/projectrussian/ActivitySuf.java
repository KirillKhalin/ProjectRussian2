...
public class ActivitySuf extends AppCompatActivity implements View.OnDragListener, View.OnLongClickListener {
    ...
    public void goAnswer(View view) {
        ...
        tView.setText(" усидчИвый (чив неизм.) ");
        tView = (TextView) findViewById(R.id.txt2);
        tView.setText(" отстегИвавший (отстегиваю) ");
        tView = (TextView) findViewById(R.id.txt3);
        tView.setText(" глянцЕвый (ев без ударения) ");
        tView = (TextView) findViewById(R.id.txt4);
        tView.setText(" щеголЕватый (еват неизм.) ");
        tView = (TextView) findViewById(R.id.txt5);
        tView.setText(" горЕвать (горюю) ");
        tView = (TextView) findViewById(R.id.txt6);
        tView.setText(" отаплИваемый (отапливаю) ");
        tView = (TextView) findViewById(R.id.txt7);
        tView.setText(" овладЕваю (суфф. ва под удар.) ");
        tView = (TextView) findViewById(R.id.txt8);
        tView.setText(" высмеИвающий (суфф. ва без удар.) ");
        tView = (TextView) findViewById(R.id.txt9);
        tView.setText(" заботлИвый (лив неизм.) ");
        tView = (TextView) findViewById(R.id.txt10);
        tView.setText(" запечетлЕвать (суфф. ва под удар.) ");
        tView = (TextView) findViewById(R.id.txt11);
        tView.setText(" милостИвый (искл.) ");
        tView = (TextView) findViewById(R.id.txt12);
        tView.setText(" кочЕвать (кочую) ");
    }
