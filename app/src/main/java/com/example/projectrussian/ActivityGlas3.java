...
public class ActivityGlas3 extends AppCompatActivity implements View.OnDragListener, View.OnLongClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_glas3);
    ...
    public void goBack(View view) {
        Intent intent = new Intent(this, ActivityGlas2.class);
    ...
    public void goAnswer(View view) {
        ...
        tView.setText(" клАняться (под ударением) ");
        tView = (TextView) findViewById(R.id.txt2);
        tView.setText(" поклОн (под ударением) ");
        tView = (TextView) findViewById(R.id.txt3);
        tView.setText(" твОрчество (под ударением) ");
        tView = (TextView) findViewById(R.id.txt4);
        tView.setText(" поклОниться (без ударения) ");
        tView = (TextView) findViewById(R.id.txt5);
        tView.setText(" склОниться (без ударения) ");
        tView = (TextView) findViewById(R.id.txt6);
        tView.setText(" наклОниться (без ударения) ");
        tView = (TextView) findViewById(R.id.txt7);
        tView.setText(" твОрить (без ударения) ");
        tView = (TextView) findViewById(R.id.txt8);
        tView.setText(" претвОрить в жизнь (без ударения) ");
        tView = (TextView) findViewById(R.id.txt9);
        tView.setText(" утвАрь (искл.) ");
        tView = (TextView) findViewById(R.id.txt10);
        tView.setText(" плОвец (искл.) ");
        tView = (TextView) findViewById(R.id.txt11);
        tView.setText(" плОвчиха (искл.) ");
        tView = (TextView) findViewById(R.id.txt12);
        tView.setText(" плАвник (без ударения) ");
    }

    public void goNext(View view) {
        Intent intent = new Intent(this, ActivityGlas3.class);
        startActivity(intent);
    }
}