...
public class ActivityGlas extends AppCompatActivity implements View.OnDragListener, View.OnLongClickListener {
    ...
    public void goAnswer(View view) {
        ...
        tView.setText(" убИраю комнату (есть суфф. а) ");
        tView = (TextView) findViewById(R.id.txt2);
        tView.setText(" убЕру комнату (нет суфф. а) ");
        tView = (TextView) findViewById(R.id.txt3);
        tView.setText(" отпИрать замок (есть суфф. а) ");
        tView = (TextView) findViewById(R.id.txt4);
        tView.setText(" отпЕреть замок (нет суфф. а) ");
        tView = (TextView) findViewById(R.id.txt5);
        tView.setText(" удЕрет отсюда (нет суфф. а) ");
        tView = (TextView) findViewById(R.id.txt6);
        tView.setText(" удИрает отсюда (есть суфф. а) ");
        tView = (TextView) findViewById(R.id.txt7);
        tView.setText(" расстИлающийся (есть суфф. а) ");
        tView = (TextView) findViewById(R.id.txt8);
        tView.setText(" стЕлющийся (нет суфф. а) ");
        tView = (TextView) findViewById(R.id.txt9);
        tView.setText(" перестЕлить (нет суфф. а) ");
        tView = (TextView) findViewById(R.id.txt10);
        tView.setText(" лЕпит (нет суфф. а) ");
        tView = (TextView) findViewById(R.id.txt11);
        tView.setText(" налИпает (есть суфф. а) ");
        tView = (TextView) findViewById(R.id.txt12);
        tView.setText(" сИдеть (сидя) ");
    }
