...
public class ActivityNNN2 extends AppCompatActivity implements View.OnDragListener, View.OnLongClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_nnn2);
    ...
    public void goAnswer(View view) {
        ...
        tView.setText(" жемаННый (отгл. прил. искл.) ");
        tView = (TextView) findViewById(R.id.txt2);
        tView.setText(" медлеННый (отгл. прил. искл.) ");
        tView = (TextView) findViewById(R.id.txt3);
        tView.setText(" свящеННый (прич. сов.в.) ");
        tView = (TextView) findViewById(R.id.txt4);
        tView.setText(" чваННый (задача) (прич. сов.в.) ");
        tView = (TextView) findViewById(R.id.txt5);
        tView.setText(" чекаННый (прич. приставка кроме не) ");
        tView = (TextView) findViewById(R.id.txt6);
        tView.setText(" некошеНый газон (отгл. прил. 4 нет) ");
        tView = (TextView) findViewById(R.id.txt7);
        tView.setText(" некрашеНый забор (отгл. прил. 4 нет) ");
        tView = (TextView) findViewById(R.id.txt8);
        tView.setText(" коваНый (отгл. прил. 4 нет) ");
        tView = (TextView) findViewById(R.id.txt9);
        tView.setText(" жеваНый (отгл. прил. 4 нет)");
        tView = (TextView) findViewById(R.id.txt10);
        tView.setText(" клеваНый (отгл. прил. 4 нет) ");
        tView = (TextView) findViewById(R.id.txt11);
        tView.setText(" заколдоваННый (прич. приставка кроме не) ");
        tView = (TextView) findViewById(R.id.txt12);
        tView.setText(" задание выполнеНо (кр.прич.) ");
    }
