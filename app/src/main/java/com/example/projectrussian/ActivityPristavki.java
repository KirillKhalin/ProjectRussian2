...
public class ActivityPristavki extends AppCompatActivity implements View.OnDragListener, View.OnLongClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pristavki);
    ...
    public void goAnswer(View view) {
        ...
        tView.setText(" прИложение (прикладывать) ");
        tView = (TextView) findViewById(R.id.txt2);
        tView.setText(" прЕкрасный (очень) ");
        tView = (TextView) findViewById(R.id.txt3);
        tView.setText(" прЕпятствие (=пере) ");
        tView = (TextView) findViewById(R.id.txt4);
        tView.setText(" прИшкольный (около) ");
        tView = (TextView) findViewById(R.id.txt5);
        tView.setText(" прИкупить (приближение) ");
        tView = (TextView) findViewById(R.id.txt6);
        tView.setText(" прИтвориться (кем-то) (вводить в заблуждение) ");
        tView = (TextView) findViewById(R.id.txt7);
        tView.setText(" прЕвозносить (очень) ");
        tView = (TextView) findViewById(R.id.txt8);
        tView.setText(" прИоткрыть (неполнота) ");
        tView = (TextView) findViewById(R.id.txt9);
        tView.setText(" прЕступление (=пере) ");
        tView = (TextView) findViewById(R.id.txt10);
        tView.setText(" прИехать (приближение) ");
        tView = (TextView) findViewById(R.id.txt11);
        tView.setText(" прЕломление (=пере) ");
        tView = (TextView) findViewById(R.id.txt12);
        tView.setText(" прЕрвать (=пере) ");
    }

    public void goNext(View view) {
        Intent intent = new Intent(this, ActivityPristavki2.class);
        startActivity(intent);
    }
}